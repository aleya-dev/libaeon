 ...
 */
template <typename T>
concept StringLike = std::is_same_v<T, Common::String> || BasicString<T> || std::is_convertible_v<T, std::string> ||
 ...
 */
template <typename T>
concept BasicStringView = std::is_same_v<T, Common::StringView> || std::is_same_v<T, std::string_view> ||
 ...
 */
template <typename T>
concept StringViewLike = std::is_same_v<T, Common::String> || std::is_same_v<T, Common::StringView> || BasicString<T> ||
 ...
 */
template <typename T>
concept Utf8CharacterTypes = std::is_same_v<T, char> || std::is_same_v<T, char8_t>;
