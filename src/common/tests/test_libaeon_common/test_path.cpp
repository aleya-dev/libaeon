...
TEST(test_path, test_relative_to_basepath)
{
    ...
    EXPECT_EQ("C:\\MyDir\\Data\\Test.txt", Common::Path::AbsolutePath("C:\\MyDir", "Data\\Test.txt"));
#else
...
{
#if (AEON_PLATFORM_OS_WINDOWS)
    EXPECT_EQ("C:\\MyDir\\Test.txt", Common::Path::AbsolutePath("C:\\MyDir\\Data", "..\\Test.txt"));
#else
...
{
#if (AEON_PLATFORM_OS_WINDOWS)
    EXPECT_EQ("C:\\Data\\Test.txt", Common::Path::AbsolutePath("C:\\MyDir", "C:\\Data\\Test.txt"));
#else
