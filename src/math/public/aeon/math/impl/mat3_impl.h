...
inline constexpr mat3::mat3(const float m00, const float m10, const float m20, const float m01, const float m11,
                            const float m21, const float m02, const float m12, const float m22) noexcept
    : column{vector3{m00, m10, m20}, vector3{m01, m11, m21}, vector3{m02, m12, m22}}
{
}

constexpr mat3::mat3(const vector3<float> &c1, const vector3<float> &c2, const vector3<float> &c3) noexcept
    : column{c1, c2, c3}
{
}
