...
class utf8_iterator final : public base_utf_iterator<Common::StringView, char8_t>
{
public:
    ...
    explicit utf8_iterator(const Common::StringView &str) noexcept
        : base_utf_iterator<Common::StringView, char8_t>{str}
    {
        consume_bom();
        advance();
    }

    explicit utf8_iterator(const Common::StringView &str, const std::int32_t offset) noexcept
        : base_utf_iterator<Common::StringView, char8_t>{str, offset}
    {
    }
