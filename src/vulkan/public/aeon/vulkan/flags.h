...
AeonDeclareFlagOperators(access_flag)
...
AeonDeclareFlagOperators(attachment_description_flag)
...
AeonDeclareFlagOperators(buffer_usage_flag)
...
AeonDeclareFlagOperators(command_pool_create_flag)
...
AeonDeclareFlagOperators(command_buffer_usage_flag)
...
AeonDeclareFlagOperators(color_component_flag)
...
AeonDeclareFlagOperators(dependency_flag)
...
AeonDeclareFlagOperators(descriptor_pool_create_flag)
...
AeonDeclareFlagOperators(descriptor_set_layout_create_flag)
...
AeonDeclareFlagOperators(framebuffer_create_flag)
...
AeonDeclareFlagOperators(message_severity)
...
AeonDeclareFlagOperators(message_type)
...
AeonDeclareFlagOperators(image_create_flag)
...
AeonDeclareFlagOperators(image_usage_flag)
...
AeonDeclareFlagOperators(memory_flag)
...
AeonDeclareFlagOperators(pipeline_create_flag)
...
AeonDeclareFlagOperators(pipeline_stage_flag)
...
AeonDeclareFlagOperators(sample_count_flag)
...
AeonDeclareFlagOperators(sampler_create_flag)
...
AeonDeclareFlagOperators(shader_stage_flag)
...
AeonDeclareFlagOperators(subpass_description_flag)
